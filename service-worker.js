const CACHE='tu-market-offline-v7-auto-sync';
const FILES=['./','./index.html','./admin.html','./caja.html','./caja-dependientes.html','./zxing.min.js','./tu-market.css','./tu-market-brand.jpg','./tu-market-logo-realistic.png'];
